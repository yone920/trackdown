...
// /api/entries/:kind — kind is "movement", an alias over the `activities` table since
// 0004_v2.sql. POST/PATCH also accept the v2 activity fields (exercise, sets, reps,
// load_lb, …); see services/entries.ts.
