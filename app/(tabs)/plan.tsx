...
// The Plan tab (docs/concept-v2.md §Coach). It was a page behind an accent button at the
// bottom of Today, which meant the answer to "what should I do?" was three scrolls and a
// tap away from the question (user decision 2026-09-01). It is a tab now; Today keeps a
// one-line status row that switches to it.
//
// **A tab is a faster door to the same behaviour, never a different one.** No schedule, no
// notification, no second place that generates advice. The brief is cached for the day on
// the server, so asking twice is consistent and free, and *Regenerate* is explicit.
//
// **Opening this screen does not generate anything** (user decision 2026-08-31 §2), and
// that mattered more the moment it became a tab: a tab is opened by accident, on the way
// to somewhere else, dozens of times a day. The
  ...
  return (
    <ScrollView
      ...
      contentContainerStyle={{
        ...
        // 140 clears the tab bar and the floating +, like the other tabs.
